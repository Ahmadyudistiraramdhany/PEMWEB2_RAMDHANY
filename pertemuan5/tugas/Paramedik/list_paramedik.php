...
<head>
    ...
    <title>Data Paramedik - Puskesmas</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <h1 class="mt-3">Data Paramedik</h1>
            </div>
        </section>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="mb-3 flex justify-between">
                    ...
                    <a href="form_paramedik.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Tambah Paramedik</a>
                </div>
                    ...
                    <table class="min-w-full text-center">
                        <thead class="bg-blue-600 text-white">
                            <tr>
                                ...
                                <th class="py-2 px-4">Unit Kerja</th>
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="py-2 px-4"><?= $row->unitkerja_id ?></td>
                                <td class="py-2 px-4">
                                    <div class="d-flex justify-content-start space-x-2">
                                        <a href="form_paramedik.php?id=<?= $row->id ?>" class="btn btn-warning btn-sm">Edit</a>
                                        <a href="proses_paramedik.php?hapus=1&id=<?= $row->id ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm">Hapus</a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            <?php if (empty($rs)): ?>
                            <tr>
                                <td colspan="10" class="py-4 text-center text-gray-500">Data belum tersedia.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
