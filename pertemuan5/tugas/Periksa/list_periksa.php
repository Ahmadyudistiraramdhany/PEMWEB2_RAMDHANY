...
<head>
    ...
    <title>Data Pemeriksaan - Puskesmas</title>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview">
                    ...
                    <li class="nav-item">
                        <a href="../kelurahan/list_kelurahan.php" class="nav-link">
                            <i class="nav-icon fas fa-map-marked-alt"></i><p>Kelurahan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../paramedik/list_paramedik.php" class="nav-link">
                            <i class="nav-icon fas fa-user-md"></i><p>Paramedik</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../pasien/list_pasien.php" class="nav-link">
                            <i class="nav-icon fas fa-procedures"></i><p>Pasien</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="list_periksa.php" class="nav-link active">
                            <i class="nav-icon fas fa-notes-medical"></i><p>Periksa</p>
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <h1 class="mt-3">Data Pemeriksaan</h1>
            </div>
        </section>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="mb-3 flex justify-between">
                    ...
                    <a href="form_periksa.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Tambah Pemeriksaan</a>
                </div>
                ...
                <div class="bg-white shadow-md rounded-lg overflow-x-auto">
                    <table class="min-w-full text-center">
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="py-2 px-4">
                                    <div class="d-flex justify-content-start space-x-2">
                                        ...
                                        <a href="proses_periksa.php?hapus=1&id=<?= $row->id ?>" onclick="return confirm('Hapus data ini?')" class="btn btn-danger btn-sm">Hapus</a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            <?php if (empty($rs)): ?>
                            <tr>
                                <td colspan="9" class="py-4 text-center text-gray-500">Belum ada data pemeriksaan.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
